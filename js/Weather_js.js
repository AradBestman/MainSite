let linkApi = "https://api.open-meteo.com/v1/forecast?latitude=31.971&longitude=34.7894&hourly=temperature_2m,rain,snowfall,snow_depth&daily=temperature_2m_max,temperature_2m_min,sunrise,sunset,uv_index_max,windspeed_10m_max,windgusts_10m_max&timezone=auto";
...
const process=(dataObj)=>{
    ...
    windspeed.innerText='min: '+ dataObj.daily.windgusts_10m_max[0] + " max: "+dataObj.daily.windgusts_10m_max[dataObj.daily.windgusts_10m_max.length-1]
